...
| Path | Purpose |
|---|---|
| docs/index.html | `/` — how the MCAgents core plugin works, and what is built on it. |
| docs/chat/index.html | `/chat/` — how the MCAgentsChat plugin works. |
...
| docs/logs/{major}/{minor}/{patch}/index.html | Permalink for one released MCAgents version (`1/0/0`, `2/0/0`, `3/0/0`, `3/1/0`, `4/0/0`, `5/0/0`, `5/1/0`, `6/0/0`). |
...
and must not be moved), MCAgentsChat at
`docs/logs/chat/{major}/{minor}/{patch}/`, and MCAgentsNPC at
